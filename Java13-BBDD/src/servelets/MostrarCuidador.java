		...
		if (errorIdCuidadorAusente) {
			...
			try {
				...
				if (!rset.isBeforeFirst()) {
					...
					errorIdCuidadorInexistente = true;
				}

				// Paso 5: Mostrar resultados

				if (errorIdCuidadorInexistente) {
					out.println("<h3>Cuidador no existente</p>");
				...
				out.print("<br/><a href='/Java13-BBDD/MostrarCuidadores'>volver</a>");
