...
public class MostrarAnimales extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			out.print("<th>Especie</th>");
			out.print("<th>Imagen</th>");
			out.print("</tr>");
			while (rset.next()) {
				// out.println("<p>" + rset.getString("nombre") + ", " +
				// rset.getString("especie") + "</p>");
				out.print("<tr>");
				out.print("<td>" + rset.getString("nombre") + "</td>");
				out.print("<td>" + rset.getString("especie") + "</td>");
				out.print("<td><img src='img/" + rset.getString("imagen") + "' width='100px' ></td>");
				out.print("</tr>");
			}
			out.print("</table>");
			// Paso 6: Desconexión
