...
public class Poste {
	...
	primero, utilizando el método “dibujar” que programamos en la clase Disco. Al final
	dibujaremos la base del poste. La base consiste en símbolos “=”: para que el dibujo
	quede bien, habrá 2 más que el diámetro del disco más grande contenido en el poste.
	Por ejemplo, si el disco más grande tiene diámetro 7, la base del poste tendrá 9
	símbolos “=”:*/
